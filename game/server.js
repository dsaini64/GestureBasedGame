...
var update = function(delta) {
    ...
    for(var i = 0; i < bluetowers.length; i++)
    {
         ...
         for(var j = 0; j < minionsblueteam.length; j++)
          {
              if((Math.sqrt((minionsblueteam[j].position.x + bluetowers[j].position.x)^2) + ((minionsblueteam[i].position.y + bluetowers[j].position.y)^2)) > 10)
            {
                //shoot the bullet!
            }

              if((Math.sqrt((minionsblueteam2[j].position.x + bluetowers[j].position.x)^2) + ((minionsblueteam2[i].position.y + bluetowers[j].position.y)^2)) > 10)
            {
                //shoot the bullet!
            }

              if((Math.sqrt((minionsblueteam3[j].position.x + bluetowers[j].position.x)^2) + ((minionsblueteam3[i].position.y + bluetowers[j].position.y)^2)) > 10)
            {
                //shoot the bullet!
            }
